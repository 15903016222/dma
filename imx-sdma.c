...
printk ("%s [%s] : %d sdma->regs = 0x%x \n", __FILE__, __func__, __LINE__, (u32)sdma->regs);
	evt = readl_relaxed(sdma->regs + SDMA_H_EVTOVR);
printk ("%s [%s] : %d sdma->regs + SDMA_H_EVTOVR = 0x%x \n", __FILE__, __func__, __LINE__, (u32)sdma->regs + SDMA_H_EVTOVR);
printk ("%s [%s] : %d evt = %d \n", __FILE__, __func__, __LINE__, evt);
	mcu = readl_relaxed(sdma->regs + SDMA_H_HOSTOVR);
printk ("%s [%s] : %d sdma->regs + SDMA_H_HOSTOVR = 0x%x \n", __FILE__, __func__, __LINE__, (u32)sdma->regs + SDMA_H_HOSTOVR);
printk ("%s [%s] : %d mcu = %d \n", __FILE__, __func__, __LINE__, mcu);
	dsp = readl_relaxed(sdma->regs + SDMA_H_DSPOVR);
printk ("%s [%s] : %d sdma->regs + SDMA_H_DSPOVR = 0x%x \n", __FILE__, __func__, __LINE__, (u32)sdma->regs + SDMA_H_DSPOVR);
printk ("%s [%s] : %d dsp = %d \n", __FILE__, __func__, __LINE__, dsp);
	if (dsp_override){
		dsp &= ~(1 << channel);
		}
	else{
printk ("%s [%s] : %d dsp_override \n", __FILE__, __func__, __LINE__);
printk ("%s [%s] : %d channel = %d \n", __FILE__, __func__, __LINE__, channel);
printk ("%s [%s] : %d before set dsp = %d \n", __FILE__, __func__, __LINE__, dsp);
		dsp |= (1 << channel);
printk ("%s [%s] : %d after set dsp = %d \n", __FILE__, __func__, __LINE__, dsp);
		}

	if (event_override){
printk ("%s [%s] : %d event_override \n", __FILE__, __func__, __LINE__);
printk ("%s [%s] : %d channel = %d \n", __FILE__, __func__, __LINE__, channel);
printk ("%s [%s] : %d before set evt = %d \n", __FILE__, __func__, __LINE__, evt);
		evt &= ~(1 << channel);
printk ("%s [%s] : %d after set evt = %d \n", __FILE__, __func__, __LINE__, evt);
		}
	else
		evt |= (1 << channel);
...
printk ("%s [%s] : %d mcu_override \n", __FILE__, __func__, __LINE__);
printk ("%s [%s] : %d channel = %d \n", __FILE__, __func__, __LINE__, channel);
printk ("%s [%s] : %d before clear mcu = %d \n", __FILE__, __func__, __LINE__,mcu);
		mcu |= (1 << channel);
printk ("%s [%s] : %d after clear mcu = %d \n", __FILE__, __func__, __LINE__, mcu);
		}
...
printk ("%s [%s] : %d BIT (channel) = 0x%x \n", __FILE__, __func__, __LINE__, BIT(channel));
printk ("%s [%s] : %d sdma->regs + SDMA_H_START = 0x%x \n", __FILE__, __func__, __LINE__, (u32)sdma->regs + SDMA_H_START);
...
printk ("%s [%s] : %d, sdmac->mode:%d\n", __FILE__, __func__, __LINE__, sdmac->mode);
...
printk ("%s [%s] : %d context->gReg[0] = %d\n", __FILE__, __func__,__LINE__, context->gReg[0]);
		context->gReg[1] = sdmac->event_mask0;
printk ("%s [%s] : %d context->gReg[1] = %d\n", __FILE__, __func__,__LINE__, context->gReg[1]);
		context->gReg[2] = sdmac->per_addr;
printk ("%s [%s] : %d context->gReg[2] = %d\n", __FILE__, __func__,__LINE__, context->gReg[2]);
		context->gReg[6] = sdmac->shp_addr;
printk ("%s [%s] : %d context->gReg[6] = %d\n", __FILE__, __func__,__LINE__, context->gReg[6]);
		context->gReg[7] = sdmac->watermark_level;
printk ("%s [%s] : %d context->gReg[7] = %d\n", __FILE__, __func__,__LINE__, context->gReg[7]);
		break;
	}
...
printk ("%s [%s] : %d \n", __FILE__, __func__, __LINE__);
printk ("sdmac->direction : DMA_DEV_TO_MEM \n");
...
printk ("%s [%s] : %d load_address =0x%x \n", __FILE__, __func__, __LINE__, load_address);
...
printk ("%s [%s] : %d context =0x%x \n", __FILE__, __func__,__LINE__,(u32)context);
	context->channel_state.pc = load_address;
printk ("%s [%s] : %d context->channel_state.pc = %d\n", __FILE__, __func__,__LINE__, context->channel_state.pc);
	...
	spin_unlock_irqrestore(&sdma->channel_0_lock, flags);
printk ("%s [%s] : %d sdma_load_context is over ret = %d\n", __FILE__, __func__,__LINE__, ret);
...
printk ("%s [%s] : %d peripheral_type:IMX_DMATYPE_DSP \n", __FILE__, __func__, __LINE__);
		break;
	case IMX_DMATYPE_MEMORY:
		sdma_config_ownership(sdmac, false, true, false);
printk ("%s [%s] : %d peripheral_type:IMX_DMATYPE_MEMORY \n", __FILE__, __func__, __LINE__);
		break;
	default:
printk ("%s [%s] : %d peripheral_type:default \n", __FILE__, __func__, __LINE__);
...
printk ("%s [%s] : %d NO IMX_DMATYPE_MEMORY || NO IMX_DMATYPE_DSP \n", __FILE__, __func__, __LINE__);
...
if (direction == DMA_DEV_TO_MEM) {
	...
	printk ("sdmac->direction : xx  NO DMA_DEV_TO_MEM \n");
}
	ret = sdma_load_context(sdmac);
	if (ret)
		goto err_out;
